...
export default function WebsiteInfo({ price = { once: '900', care: '29' }, canonical = 'https://www.nuvion-solutions.com/websites' }) {
  ...
  const FAQS = [
    ...
    [t('How long does it take?', '¿Cuánto tarda?'), t('Days, not months. Plan on live inside a week of your onboarding form coming back.', 'Días, no meses. Cuenta con que estará en vivo dentro de una semana de que regreses tu formulario de inicio.')],
