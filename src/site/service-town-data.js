...
export const SERVICES = {
  seo: {
    ...
    name: `Local SEO`,
    metaLead: `Local SEO`,
    metaDescTpl: `Local SEO in {town} that lands your business in Google's map pack and the "near me" results. Month to month, honest reporting, and no long-term contract.`,
    h1a: `Get found by`,
  ...
  marketing: {
    ...
    metaDescTpl: `Marketing and social for {town} businesses — social posts, reviews, and follow-up that keep you in front of local customers. Optional add-ons, month to month.`,
    h1a: `Keep`,
