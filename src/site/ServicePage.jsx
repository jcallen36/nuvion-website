...
export const WEB_DESIGN = {
  ...
  plans: [
    { name: 'Websites', price: 'from $600', per: 'one-time · or $49/mo, $0 down', desc: 'Own it outright, or go monthly with $0 down — the site is yours to keep either way (after 24 months on monthly).', features: ['Custom, mobile-first design', 'SEO-ready build', 'Live in 1 week — or you don’t pay', 'You own it — outright, or after 24 months on monthly'], cta: 'Start your site', highlight: true },
  ...
  faqs: [
    ...
    { q: 'Do I own my website?', a: 'You do. Pay once and it’s yours the moment the build is paid — design, files, domain, all of it, and you can host it anywhere. Prefer monthly? It’s $0 down and the site becomes fully yours after 24 months. Either way it ends up yours — the optional care plans (from $29/mo) just handle hosting, security, and backups for you.' },
  ...
  es: {
    ...
    plans: [
      { name: 'Sitios web', price: 'desde $600', per: 'pago único · o $49/mes, $0 inicial', desc: 'Págalo una vez, o ve mensual con $0 inicial — el sitio es tuyo de cualquier forma (después de 24 meses en el plan mensual).', features: ['Diseño personalizado, pensado para el móvil', 'Construido listo para SEO', 'En vivo en 1 semana — o no pagas', 'Es tuyo — de una vez, o después de 24 meses en el mensual'], cta: 'Comienza tu sitio', highlight: true },
