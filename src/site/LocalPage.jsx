      ...
      <main>
        ...
        <section className="nv-sec soft"><div className="nv-wrap">
          ...
          <div className="lp-faq">
            ...
            <details className="rv"><summary>{t(`How fast can my ${town} website launch?`, `¿Qué tan rápido puede lanzarse mi sitio en ${town}?`)}</summary><div className="a">{t("One week — guaranteed. Once we have your content and go-ahead, your custom site goes live within 1 week. If we miss it, you don't pay.", 'Una semana — garantizado. Una vez que tenemos tu contenido y luz verde, tu sitio personalizado se lanza en 1 semana. Si no lo logramos, no pagas.')}</div></details>
