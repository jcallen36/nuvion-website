...
export default function AboutPage() {
  ...
  const concepts = [
    { img: workFloors, name: 'Floors for Sonoma', cat: t('Concept · Flooring Studio', 'Concepto · Estudio de pisos'), result: t('An editorial, high-end concept for a Sonoma Valley flooring studio.', 'Un concepto editorial y de alta gama para un estudio de pisos de Sonoma Valley.'), url: 'https://floors-for-sonoma.vercel.app' },
